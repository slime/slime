(require 'sly-enclosing-context)
(require 'sly-tests)
(require 'cl-lib)

(def-sly-test enclosing-context.1
  ...
  '(("(flet ((,nil ()))
     ...
     ;; still return ,nil for the `sly-enclosing-bound-functions',
     ...
     ;; `sly-symbol-at-point' now does TRT and does not return a
